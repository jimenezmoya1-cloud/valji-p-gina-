...
const PRODUCTS = [
  /* =================== PROTEÍNAS =================== */
  {
    ...
    images: [
      'assets/img/assets/img/productos/proteina-oikos-shake/chocolate.webp',
      'assets/img/assets/img/productos/proteina-oikos-shake/vainilla.webp',
    ],
  ...
  },
  {
    ...
    flavors: ['Chocolate'],
    images: [
      'assets/img/assets/img/productos/proteina-muscle-milk-shake/chocolate.png',
    ],
  ...
  },
  {
    ...
    images: [
      'assets/img/assets/img/productos/proteina-muscle-milk-cero-1.65-lbs/vainilla-creme.png',
    ],
  ...
  /* =================== POWERGEL =================== */
  {
    ...
    images: [
      'assets/img/assets/img/productos/powergel-original-24u/fresa-banano.webp',
      'assets/img/assets/img/productos/powergel-original-24u/lima-limon.webp',
      'productos/PowerGel Original 24U/Manzana verde (+Cafeína).webp',
      'assets/img/assets/img/productos/powergel-original-24u/vainilla.webp',
    ],
  ...
  },
  {
    ...
    flavors: ['Limón'],
    images: [
      'assets/img/assets/img/productos/fuel-30-gel-12u/limon.webp',
    ],
  ...
  },
  {
    ...
    images: [
      'productos/PowerGel Hydro 24U/Cereza (+ Cafeína).webp',
      'productos/PowerGel Hydro 24U/Cola (+ Cafeína).webp',
      'productos/PowerGel Hydro 24U/Mojito (+ Cafeína).webp',
      'assets/img/assets/img/productos/powergel-hydro-24u/naranja.webp',
    ],
  ...
  },
  {
    ...
    images: [
      'assets/img/assets/img/productos/powergel-shots-24u/frambuesa.webp',
      'assets/img/assets/img/productos/powergel-shots-24u/naranja.webp',
    ],
  ...
  },
  {
    ...
    images: [
      'assets/img/assets/img/productos/powergel-smothies-16u/banana-blueberry.webp',
    ],
  ...
  /* =================== ELECTROLITOS =================== */
  {
    ...
    images: [
      'productos/5 Electrolytes/Limón (+Cafeína).webp',
    ],
  ...
  },
  {
    ...
    images: [
      'assets/img/assets/img/productos/isoactive-bebida-isotonica-600g/limon.webp',
      'assets/img/assets/img/productos/isoactive-bebida-isotonica-600g/naranja.webp',
      'assets/img/assets/img/productos/isoactive-bebida-isotonica-600g/red-fruit.webp',
    ],
  ...
  },
  {
    ...
    images: [
      'assets/img/assets/img/productos/isoactive-bebida-isotonica-1320g/naranja.webp',
      'assets/img/assets/img/productos/isoactive-bebida-isotonica-1320g/red-fruit.webp',
    ],
  ...
  },
  {
    ...
    flavors: ['Limón'],
    images: [
      'assets/img/assets/img/productos/fuel-90-bebida-deportiva-alta-en-carbohidratos/limon.webp',
    ],
  ...
  },
  {
    ...
    flavors: ['Limón'],
    images: [
      'assets/img/assets/img/productos/iso-fuel-30-bebida-isotonica/limon.webp',
    ],
  ...
  /* =================== BARRAS =================== */
  {
    ...
    images: [
      'assets/img/assets/img/productos/energize-original-15u/banana-punch.webp',
      'assets/img/assets/img/productos/energize-original-15u/berry.webp',
      'assets/img/assets/img/productos/energize-original-15u/cookies-cream.webp',
    ],
  ...
  },
  {
    ...
    images: [
      'assets/img/assets/img/productos/proteincrisp-barrita-de-proteina-40-12u/caramelo.webp',
      'assets/img/assets/img/productos/proteincrisp-barrita-de-proteina-40-12u/choco-coco.webp',
      'assets/img/assets/img/productos/proteincrisp-barrita-de-proteina-40-12u/fresa-chocolate-blanco.webp',
    ],
